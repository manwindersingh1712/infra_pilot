...
const serviceIcons: Record<string, string | JSX.Element> = {
  docker: (
  ...
  redis: (
    <svg width="32" height="32" viewBox="0 0 256 256" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M245.965 101.351c-13.661 7.12-84.431 36.218-99.498 44.075-15.066 7.854-23.436 7.777-35.338 2.087-11.903-5.686-87.214-36.112-100.78-42.594-13.566-6.483-13.85-10.947-.524-16.167 13.326-5.22 88.224-34.605 104.055-40.284 15.828-5.677 21.319-5.884 34.789-.949 13.471 4.934 83.819 32.933 97.13 37.81 13.316 4.88 13.827 8.9.166 16.02" fill="#C6302B"/>
...
export function ServiceNode({ id, data, selected }: ServiceNodeProps) {
  const icon = serviceIcons[data.serviceType] || serviceIcons.nodejs;
  ...
  return (
    <div
      style={{
        ...
        boxShadow: selected
          ? "0 0 0 2px rgba(139, 92, 246, 0.3), 0 8px 32px rgba(0,0,0,0.4)"
      ...
      <div style={{ padding: "0 16px 16px" }}>
        <div
          style={{
            ...
            gap: "8px",
            fontSize: "13px",
            color: hasDeployments ? "#6ee7b7" : "#9ca3af",
          }}
        >
          <span
            style={{
              ...
              height: "6px",
              borderRadius: "50%",
              background: hasDeployments ? "#22c55e" : "#6b7280",
              boxShadow: hasDeployments ? "0 0 6px rgba(34, 197, 94, 0.5)" : "none",
            }}
          />
          {hasDeployments ? "Online" : "Offline"}
        </div>
      </div>

      {/* Bottom info section (if volume or additional info exists) */}
      {(data.volumeName || data.runtimeUrl) && (
        <div
          style={{
            padding: "10px 16px",
        ...
        >
          ...
          <span
            ...
            title={data.volumeName || data.runtimeUrl}
          >
            {data.volumeName || data.runtimeUrl}
          </span>
        </div>
